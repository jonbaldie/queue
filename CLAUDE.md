...
**YOU ARE IN: `queue/polecats/nitro/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/queue/` (rig root) or other directories
...
**Your mail address:** `queue/polecats/nitro`
**Your rig:** queue
**Your Witness:** `queue/witness`
...
| Ask Witness for help | `gt mail send queue/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`queue/witness`) when:
...
```bash
gt mail send queue/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
